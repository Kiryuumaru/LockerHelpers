...
class Build : BaseNukeBuildHelpers
{
    ...
    BuildEntry LockerHelpersBuild => _ => _
        ...
        .Execute(context =>
        {
            ...
            DotNetTasks.DotNetClean(_ => _
                .SetProject(RootDirectory / "LockerHelpers" / "LockerHelpers.csproj"));
            DotNetTasks.DotNetBuild(_ => _
                .SetProjectFile(RootDirectory / "LockerHelpers" / "LockerHelpers.csproj")
    ...
    PublishEntry LockerHelpersPublish => _ => _
        .AppId("locker_helpers")
        .RunnerOS(RunnerOS.Ubuntu2204)
